        ...
        Row (modifier = Modifier
            ...
            Card (
                ...
                Column (
                    ...
                    Text(text = "Available Requests", fontSize = 25.sp, color = Color.White, modifier = Modifier.padding(start = 5.dp, end = (5.dp)))
...
fun MechanicDashboardScreenPreview(){
    ...
    MechanicDashboardScreen(rememberNavController())
}